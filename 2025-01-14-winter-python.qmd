---
title: "Winter 2025 Python Workshop Survey Responses"
editor: visual
format: 
   html:
     code-fold: true
...
workshops <- c("2025-01-14-ucsb-python")
...
```{r}
#| message: false
shoreline <- read_csv("data/admin_download_ucsb_events_attendees_tickets_113181243.csv")
```

## Departments (from Shoreline)
...
## Current occupation / Career stage (from Shoreline)
