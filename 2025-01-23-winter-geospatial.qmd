---
title: "Winter 2025 Geospatial Workshop Survey Responses"
editor: visual
format: 
   html:
     code-fold: true
...
workshops <- c("2025-01-23-ucsb-geospatial")
...
shoreline <- read_csv("data/shoreline/2025-01-23-ucsb-geospatial-shoreline.csv") %>% 
  filter(`RSVP'ed`=='Yes')
