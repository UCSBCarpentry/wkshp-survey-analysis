---
title: "Winter 2025 Containers Workshop Survey Responses"
editor: visual
format: 
   html:
     code-fold: true
...
workshops <- c("2025-01-15-ucsb-containers")
...
shoreline <- read_csv("data/shoreline/2025-01-15-ucsb-containers-shoreline.csv") %>% 
  filter(`RSVP'ed`=='Yes')
